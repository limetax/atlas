...
const PREDEFINED_PROMPTS = [
  {
    ...
    prompt: 'Bitte gib mir eine Zusammenfassung aller offenen Fristen für alle Mandanten.',
  },
  {
    icon: '⚖️',
    title: 'Steuerliche Einordnung',
    description: 'Erkläre die steuerliche Behandlung eines Sachverhalts',
    prompt: 'Ich benötige eine steuerliche Einordnung für folgenden Sachverhalt: ',
  },
  {
    icon: '📊',
  ...
  },
  {
    ...
    prompt: 'Erstelle einen anonymisierten Vergleich der Bearbeitungszeiten für ähnliche Fälle.',
  },
];
            ...
            <div className="space-y-8">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Ihr KI-Assistent für steuerrechtliche Fragen, Mandantenvorbereitung und Fristenverwaltung.
                  Gestützt auf deutsche Steuergesetze und Ihre Mandantendaten.
                </p>
              </div>

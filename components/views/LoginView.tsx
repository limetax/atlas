...
export const LoginView: React.FC<LoginViewProps> = ({ redirectTo }) => {
  return (
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg max-w-md">
              Ihr intelligenter KI-Assistent für steuerrechtliche Fragen,
              Mandantenvorbereitung und Fristenverwaltung.
            </p>
          </div>
